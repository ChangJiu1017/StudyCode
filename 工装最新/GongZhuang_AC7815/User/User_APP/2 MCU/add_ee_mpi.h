...
//2016-2-23 MOVE FROM SCR
//³µÁ¾ÔËÐÐ²ÎÊý¼ÍÂ¼
//2016-2-23 ¸ü¸ÄÎªÄ¦ÍÐ³µµÄÓ¦ÓÃ				
	#define	ADD_DC		0x300//2015-10-28 4-C-0
	#define	ADD_WUC		0x303
	#define	ADD_OBDC		0x306
	#define	ADD_ENG_RT		0x308
	#define	ADD_DOSER_NB		0x30C
	#define	ADD_KEY_RT		0x318
	#define	ADD_SUPPLIER_NB		0x31D
	
	#define ADD_ENG_RT_MILON  0x310
	#define ADD_ENG_RT_CLRDTC  0x314
	
	#define ADD_FUEL_COMSUMP_ML  0x320 //ÀÛ¼ÆÈ¼ÓÍÏûºÄÁ¿
	#define ADD_DEF_COMSUMP_ML  0x324   //ÀÛ¼ÆÄòËØÏûºÄÁ¿
	#define ADD_NH3_ST_ML  0x328        //ÉÏ´Î°±´æ´¢Á¿
	
//2015-11-28 ¶³½áÖ¡µÄ´æ´¢Î»ÖÃ
  #define ADD_FROZEN_ID 0x340
  #define ADD_FROZEN_T  0x341
  #define ADD_FROZEN_N  0x342
  #define ADD_FROZEN_ET  0x344
  #define ADD_FROZEN_TSCR  0x345


//¹ÊÕÏÊýÁ¿
  #define ADD_DTC_NUM_NONECLR   0x32E
  #define ADD_DTC_NUM_CLR       0x32F


// FIRST ADD for DTC ´æ´¢
  #define ADD_1ST_DTC 0x360       //
  #define NUM_DTC_HISTORY 10//×ÜµÄÔÊÐí´æ´¢µÄ¹ÊÕÏ¶³½áÖ¡µÄÊýÁ¿
  
  //Ò»¹²26¸öÎ»ÖÃ£¬ÆäÖÐÇ°10¸öÎª²»¿ÉÇå³ý¹ÊÕÏµÄÎ»ÖÃ
  #define ID_DTC_HISTORY_ST_NOCLR 0
  #define ID_DTC_HISTORY_ED_NOCLR 2
  #define ID_DTC_HISTORY_ST_CLR   3
  #define ID_DTC_HISTORY_ED_CLR   9
